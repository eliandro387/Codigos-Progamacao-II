...
void inserePosicao(int valor, int posicao) {
	...
	// Decidindo o ponto de incio, pra saber se ele começa a "varrer" do inicio ou do fim
...
void imprimeLista() {
	...
	if(atual != NULL){
		while(atual){
			...
			printf(" ponteiro anterior %d",atual->anterior);
			printf(" proximo ponteiro %d\n",atual->proximo);
			atual=atual->proximo;
		}
	}
